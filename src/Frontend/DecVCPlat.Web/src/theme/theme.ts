...
const customProperties = {
  custom: {
    gradients: {
      ...
      secondary: 'linear-gradient(45deg, #f50057 30%, #ff5983 90%)',
...
Object.assign(lightTheme, customProperties);
Object.assign(darkTheme, customProperties);
