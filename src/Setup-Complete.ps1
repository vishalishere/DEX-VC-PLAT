...
# Fixed version that uses the corrected solution file
...
# Use the fixed solution file
Write-Host "Using fixed solution file (DecVCPlat.Fixed.sln)..." -ForegroundColor Cyan

# Restore .NET packages
Write-Host "Restoring .NET packages..." -ForegroundColor Cyan
dotnet restore DecVCPlat.Fixed.sln
...
dotnet build DecVCPlat.Fixed.sln
